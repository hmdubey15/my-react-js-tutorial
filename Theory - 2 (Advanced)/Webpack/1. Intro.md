...
- Sets <span style="color: Gold;">process.env.NODE_ENV</span> is set to <span style="color: HotPink;">development</span> for conditional compilation.
...
- Sets <span style="color: Gold;">process.env.NODE_ENV</span> is set to <span style="color: HotPink;">production</span> for conditional compilation.

...
- Create a custom context provider for managing a complex form state. The form has multiple sections, and each section has several fields. (May be just like form builder)

   - Use React Context API and useReducer for state management.
   - Optimize the context to avoid unnecessary re-renders of components that do not depend on the state.
   - Implement a way to validate the form and show errors dynamically.
...
- NINJA QUESTIONS OF THIS SITE - https://web.codeclimbjs.com/

<br>

- withActions custom HOC like in Tekion
...
- Search API fetch + Pagination => Use custom debounce and intersection observer

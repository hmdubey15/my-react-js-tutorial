...
In the very beginning of web development world, html files of big projects used to be like the given below file. Import order was necessary because some scripts depended on others. A couple of files could be managed like this but what if there are 100s of files dependent on each other? One minor error in ordering and entire system would collapse. Then came the entry of <span style="color: Orange;">webpack</span>!
